...
import { registerUser, updateProfile } from "@/services/apiBlogs";
import InputError from "@/components_ui/InputError";
    ...
    rounded-lg bg-[#FFFFFF] shadow-xl dark:text-white dark:bg-[#141624]`}
        ...
        >
          ...
          <div className="flex flex-col gap-1 ">
            <Label htmlFor="username" className="dark:text-[97989F] p-1 ">
              Username
            </Label>
            <Input
              type="text"
          ...
          <div className="flex flex-col gap-1">
            <Label className=" p-1" htmlFor="first_name">
              First Name
            </Label>
            <Input
              type="text"
          ...
          <div className="flex flex-col gap-1">
            <Label className=" p-1" htmlFor="last_name">
              Last Name
            </Label>
            <Input
              type="text"
          ...
          {updateForm && (
            <div>
              <Label htmlFor="job_title" className="dark:text-[97989F]  p-1">
                Job Title
              </Label>
              <Input
                type="text"
          ...
          {updateForm && (
            <div>
              <Label className=" p-1" htmlFor="content">
                Bio
              </Label>
              <Textarea
                id="content"
